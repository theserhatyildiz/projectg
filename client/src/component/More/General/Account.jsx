...
export default function Account() {
    ...
    fetch("https://galwinapp-c654a544b729.herokuapp.com/update-username", {
        method: "POST",
    ...
    function logout() {
        fetch('https://galwinapp-c654a544b729.herokuapp.com/logout', { // Ensure you have the correct URL
            method: 'POST',
            headers: {
