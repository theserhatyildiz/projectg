...
export default function Account() {
    ...
    fetch("https://galwinapp-84e0263e418c.herokuapp.com/update-username", {
        method: "POST",
    ...
    function logout() {
        fetch('https://galwinapp-84e0263e418c.herokuapp.com/logout', { // Ensure you have the correct URL
            method: 'POST',
            headers: {
